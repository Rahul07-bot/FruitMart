       ...
       <div class = "footer_content">
	      <ul class = "footer_li">
		     ...
		     <li>
				...
				<h6><i class="fa fa-phone" style="font-size:20px;color:red;"></i>&nbsp;&nbsp;+91 7876013060</h6>
				<h6><i class="fa fa-envelope" style="font-size:20px;color:red;"></i>&nbsp;&nbsp;fruitmart@gmail.com</h6>
				<h6><i class="fa fa-map-marker" style="font-size:20px;color:red;"></i>&nbsp;&nbsp;Himachal Pradesh, India</h6>
			 </li>
		  </ul>
	   </div>
   </div>
